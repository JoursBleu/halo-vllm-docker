...
#
# Environment:
#   IMAGE                container image            (default: halo-vllm-node)
#   CONTAINER            container name             (default: halo_vllm_node)
...
IMAGE="${IMAGE:-halo-vllm-node}"
CONTAINER="${CONTAINER:-halo_vllm_node}"
